...
CREATE TABLE `a1tl_jj1_0log1` (
  ...
  PRIMARY KEY (`iid`)
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8 COMMENT='日志-业绩-奖金&等';

#
# Data for table "a1tl_jj1_0log1"
#

INSERT INTO `a1tl_jj1_0log1` VALUES (1,1,1,1000,100,'2016-05-08 13:20:56',1,0),(2,2,2,2000,200,'2016-05-08 13:20:19',1,0),(3,2,2,3000,300,'2016-05-08 13:19:37',2,1),(4,1,1,4000,400,'2016-05-08 09:09:05',2,1);
...
CREATE TABLE `a1tl_jj1user1yeji` (
  ...
  `jiangj` mediumint(9) DEFAULT NULL COMMENT 'bonus',
  PRIMARY KEY (`yId`)
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8 COMMENT='业绩results-奖金bonus&等';
...
INSERT INTO `a1tl_jj1user1yeji02` VALUES (6,2,3000,300,'2016-05-08 13:19:37',2,1),(7,1,4000,400,'2016-05-08 09:09:05',2,1);
